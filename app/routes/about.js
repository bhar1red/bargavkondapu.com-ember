...
export default Ember.Route.extend({
  model(){
    ...
    +"<p> I am heavily inspired from the works of Napoleon Hill, Charles Bukowski, Tony Robbins, Simon Sinek, Gary Vaynerchuk."+" My philosophy can be summarized in these 5 quotes. <br/>"
    + "<b> 1 > 0 </b> - Gary Vee <br/>"
    ...
    + "<b> It is literally true that you can succeed best and quickest by helping others to succeed. </b> - Napoleon Hill<br/>"
    + " Though our philosophy keep updating everyday, it is reflected in my work and life. Most of my blog-posts share detailed description of things I believe in.</p>"
    + "<h3> Interests </h3>"
